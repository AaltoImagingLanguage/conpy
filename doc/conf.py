...
html_context = {
    ...
    "github_user": "aaltoimaginglanguage",
    "github_repo": "conpy",
...
latex_documents = [
    (master_doc, "conpy.tex", "ConPy Documentation", "Marijn van Vliet", "manual"),
]
...
man_pages = [(master_doc, "conpy", "ConPy Documentation", ["Marijn van Vliet"], 1)]
...
texinfo_documents = [
    (
        ...
        "Marijn van Vliet",
        "mne_rsa",
        "DICS connectivity analysis on MEG data",
        "Miscellaneous",
    ),
]
