...
if user == "rodin":
    ...
    study_path = "/m/nbe/scratch/conpy"
    n_jobs = 1
elif (host == "iris.org.aalto.fi" or host == "thor.org.aalto.fi") and user == "vanvlm1":
    ...
    raise RuntimeError(
        "Please edit scripts/config.py and set the study_path "
...
fname.add("power_hemi", "{subject_dir}/{subject}-{condition}-dics-power-{hemi}.stc")
